...
export function SetDetailPage({ setId }: SetDetailPageProps) {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        switch (response.status) {
          ...
          case 400:
            alert(errorData.error?.message || "Nieprawidłowe dane. Spróbuj ponownie.");
            return;
    ...
    return (
      <div className="flex items-center justify-center min-h-screen px-4">
        <div className="text-center max-w-md">
          ...
          <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-2">Wystąpił błąd</h3>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
      ...
      <WordList words={data.words} onEdit={handleEditWord} onDelete={handleDeleteWord} />

...
type UseWordMutationsReturn = {
  addWords: (
    setId: string,
    words: WordFormValues[]
  ) => Promise<WordsAddResponseDTO>
  updateWord: (
    setId: string,
    wordId: string,
    data: Partial<WordFormValues>
  ) => Promise<WordUpdateResponseDTO>
  deleteWord: (
    setId: string,
    wordId: string
  ) => Promise<WordDeleteResponseDTO>
  isLoading: boolean
  error: string | null
}
...
export function useWordMutations(): UseWordMutationsReturn {
  ...
  const addWords = useCallback(
    async (setId: string, words: WordFormValues[]): Promise<WordsAddResponseDTO> => {
      setIsLoading(true)
      setError(null)
  ...
  const deleteWord = useCallback(
    async (setId: string, wordId: string): Promise<WordDeleteResponseDTO> => {
      setIsLoading(true)
      setError(null)
